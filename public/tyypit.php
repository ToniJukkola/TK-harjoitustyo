...
foreach($person as $p){
    echo "<tbody><tr><td>".$p["id"]." </td><td>".$p["username"]." </td><td>".$p["email"]." </td><td>".$p["firstname"]." </td><td>".$p["lastname"]." </td><td><button onChange='deletePerson()'>Poista</button><button>Muokkaa</button></td></tr></tbody>";
}
    echo "</table>";
